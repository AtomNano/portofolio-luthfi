                        ...
                        <div className="grid gap-6">
                            <div className="grid gap-2">
                                ...
                                <Input
                                    ...
                                    className="bg-gray-900 border-gray-800 text-white placeholder:text-gray-600 focus-visible:ring-cyan-500"
                                />
                            ...
                            <a
                                href="/auth/google"
                                className="flex w-full items-center justify-center gap-3 rounded-md border border-gray-800 bg-gray-900 px-6 py-3 text-white transition-all hover:bg-gray-800 hover:border-gray-600"
                            >
